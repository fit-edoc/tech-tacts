  ...
  return (
    <>
      ...
      <footer id="contact" className="bg-black  h-[70vh] w-screen  md:h-[70vh]">
        <div className="h-[70%] flex"> <div className="h-full w-[50%] bg-black text-white flex flex-col justify-center items-start px-3 gap-3 md:justify-center">
          <h1 className="border-b-2 border-white">Quick links</h1>
       <ul className="list-disc ml-4 flex flex-col gap-2 border-b-2 border-white">
      ...
      <a href="">  <li className="border-b-2 border-white inline-block">Get a Quote</li></a>
        ...
        <div className="h-full w-[50%] bg-black"></div></div>
        <motion.div className="foot h-[10%]  bg-black flex justify-center items-end gap-2 pb-2 text-white text-2xl" ><a href="" className="bg-red-500 py-1 px-1 rounded-full hover:scale-110 border-b-2 border-white "><MdContacts/> </a>
